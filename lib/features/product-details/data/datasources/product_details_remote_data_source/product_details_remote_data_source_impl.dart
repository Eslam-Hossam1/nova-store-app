...
class ProductDetailsRemoteDataSourceImpl
  ...
  @override
  Future<List<ProductCommentModel>> getProductComments(String productId) async {
    final List response = await _apiConsumer.get(
      EndPoints.getProductComments(productId),
    );
    return response.map((json) => ProductCommentModel.fromJson(json)).toList();
  }
